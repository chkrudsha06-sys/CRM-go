        ...
        <div className="min-h-0 flex-1 overflow-y-auto">
          ...
          <div className="px-6 pt-6 pb-4">
            ...
            <div className="rounded-[12px] px-4 py-3"
              ...
              <h2 className="text-[17px] font-medium leading-snug" style={{ color: "var(--text-strong)" }}>
                {notice.title}
              </h2>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3 px-6 pb-4">
            <div className="rounded-[10px] px-3 py-2.5"
              ...
              <p className="text-[13px] font-normal" style={{ color: "var(--text-strong)" }}>{notice.author}</p>
            </div>
            <div className="rounded-[10px] px-3 py-2.5"
              style={{ background: "var(--surface-2)", border: "1px solid var(--border-subtle)" }}>
              <p className="crm-tiny mb-1">게시 기간</p>
              <p className="text-[13px] font-normal" style={{ color: "var(--text-strong)" }}>
          ...
          <div className="px-6 pb-4">
            ...
            <div className="rounded-[12px] px-4 py-4"
              style={{ background: "var(--surface-2)", border: "1px solid var(--border-subtle)" }}>
              <p className="whitespace-pre-wrap text-[14px] font-normal leading-relaxed" style={{ color: "var(--text)" }}>
                {notice.content}
              </p>
            </div>
          </div>
              ...
              <div className="space-y-1.5">
                {fileUrls.map((url, i) => (
                  <a key={i} href={url} target="_blank" rel="noopener noreferrer" download={getFileName(url)}
                    ...
                    <span className="flex-1 truncate text-[13px] font-normal" style={{ color: "var(--text)" }}>
                      {getFileName(url)}
                    </span>
