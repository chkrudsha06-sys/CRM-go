...
const sectionBadgeStyle: React.CSSProperties = { display: 'inline-flex', alignItems: 'center', justifyContent: 'center', minWidth: 72, padding: '6px 9px', borderRadius: 999, background: 'var(--purple-bg)', color: 'var(--purple-text)', border: '1px solid var(--purple-border)', fontWeight: 900 };
